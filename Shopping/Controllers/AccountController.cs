    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "El usuario no ah sido habilitado, debe de seguir las instrucciones del correo enviado para poder habilitar el usuario.");
        ...
        {
            User user = await _userHelper.GetUserAsync(User.Identity.Name); // Usuario logeado
            if (user == null)
            {
                return NotFound();
            }
            ...
            EditUserViewModel model = new()
            {
                ...
                CityId = user.City.Id,
                Cities = await _comboHelper.GetComboCitiesAsync(user.City.Id),
                StateId = user.City.State.Id,
                States = await _comboHelper.GetComboStatesAsync(user.City.State.Country.Id),
                Countries = await _comboHelper.GetComboCountriesAsync(),
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "La contrasena nueva es la misma que la anterior.");
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string myToken = await _userHelper.GenerataPasswordResetTokenAsync(user);
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user != null)
            {
                ...
                ViewBag.Message = "Error cambiando la contrasena";
                return View(model);
            }
