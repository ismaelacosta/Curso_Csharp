...
namespace Shopping.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DataContext context, IComboHelper comboHelper, IBlobHelper blobHelper, IFlashMessage flashMessage)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create(CreateProductViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    {
                        isValid = true,
                        html = ModalHelper.RenderRazorViewToString(this, "_ViewAllProducts", _context.Productcs
                        .Include(p => p.ProductImages)
                        .Include(p => p.ProductCategories)
        ...
        public async Task<IActionResult> AddImage(AddProductImageViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    {
                        isValid = true,
                        html = ModalHelper.RenderRazorViewToString(this, "Details", _context.Productcs
                     .Include(p => p.ProductImages)
                     .Include(p => p.ProductCategories)
                     .ThenInclude(pc => pc.Category)
